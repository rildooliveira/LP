 ...
 * @version 1.0.0
 * * [ATIVIDADE 6] Assinatura do Autor: Altere "Seu Nome" para o seu nome real.
 * @author Seu Nome
 */
...
document.querySelector("#form-invencao").addEventListener("submit", async function(evento) {
    ...
    // [ATIVIDADE 4] Docstrings (Por que) vs Comentários Tóxicos (O que)
    // Código Limpo: Coleta automaticamente todos os inputs com o atributo 'name'
